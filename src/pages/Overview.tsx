  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div className="lg:col-span-8 space-y-6">
        {/* Banner */}
        <div className="relative bg-linear-to-tr from-orange-500 to-orange-300 text-white rounded-xl p-6 overflow-hidden">
          <div
            className="absolute inset-0 bg-cover bg-right opacity-10"
            style={{ backgroundImage: "url('/fitness.png')" }}
          />
          <div className="relative z-10 flex flex-col justify-center h-full">
            <h2 className="text-xl sm:text-2xl font-semibold">Track Your Daily Activities</h2>
            <p className="text-xs sm:text-sm mt-2 opacity-90 max-w-md">
        ...
        <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm">
          <div className="flex flex-wrap justify-between items-center gap-2 mb-4">
            <h2 className="text-base sm:text-lg font-semibold">Goal Progress</h2>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-x-auto">
          <table className="min-w-full text-sm text-left">
            <thead className="bg-gray-100 text-gray-600 uppercase text-xs">
              <tr>
                <th className="px-4 sm:px-6 py-3">Food</th>
                <th className="px-4 sm:px-6 py-3">Meal</th>
                <th className="px-4 sm:px-6 py-3">Calories</th>
                <th className="px-4 sm:px-6 py-3">Priorities</th>
            ...
            <tbody>
              {[
                ...
                <tr key={item.food} className="border-b last:border-none">
                  ...
                  <td className="px-4 sm:px-6 py-3">{item.pri}</td>
                  <td className="px-4 sm:px-6 py-3">{item.carb}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        {/* Premium Upgrade */}
        <div className="bg-linear-to-r from-purple-500 to-orange-400 text-white rounded-xl p-4 sm:p-5 flex flex-row justify-between items-center gap-4">
          <div>
            <h4 className="text-base sm:text-lg font-semibold">50% off on Premium Membership</h4>
            <p className="text-xs sm:text-sm mt-1 opacity-90">Unlock exclusive workouts and plans.</p>
            <button className="mt-3 bg-white text-purple-700 font-semibold text-xs sm:text-sm px-4 py-2 rounded-lg">
              Upgrade
            </button>
          </div>
          <img src="/premium.png" alt="Upgrade" className="w-24 sm:w-28" />
        </div>
      </div>
    </div>
  );
