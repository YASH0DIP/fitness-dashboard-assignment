...
export default function ScheduleCard({ day, title, time, tag }: ScheduleCardProps) {
  return (
    <div className="flex justify-between items-center bg-white shadow-xl rounded-xl px-3 sm:px-4 py-2 sm:py-3 hover:shadow-sm transition text-sm sm:text-base">
      <div>
